...
dform longleftrightarrow_df	: mode[html] :: longleftrightarrow        = html_uni[0x27F5] html_sym["ndash"] html_uni[0x27F6] (* html_uni[0x27F7] *)
dform longleftarrow_df		: mode[html] :: longleftarrow             = html_uni[0x27F5] html_sym["ndash"]
dform longrightarrow_df		: mode[html] :: longrightarrow            = html_sym["ndash"] html_uni[0x27F6]
