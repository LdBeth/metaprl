...
struct
   ...
   let ext_memo =
      { attribute = WeakMemo.create_default "Proof_term_boot.ext_memo.attribute" (**)
           weaken_attribute_header compare_attribute ext_make_attribute empty_gci;
        attributes = WeakMemo.create_default "Proof_term_boot.ext_memo.attributes" (**)
           weaken_attributes_header compare_attributes ext_make_attributes empty_gci;
        arglist = WeakMemo.create_default "Proof_term_boot.ext_memo.arglist" (**)
           weaken_arglist_header compare_arglist ext_make_arglist empty_gci;
        tactic_parent = WeakMemo.create_default "Proof_term_boot.ext_memo.tactic_parent" (**)
           weaken_tactic_parent_header compare_tactic_parent ext_make_tactic_parent empty_gci;
        tactic_arg = WeakMemo.create_default "Proof_term_boot.ext_memo.tactic_arg" (**)
           weaken_tactic_arg_header compare_tactic_arg ext_make_tactic_arg empty_gci;
        extract = WeakMemo.create_default "Proof_term_boot.ext_memo.extract" (**)
           weaken_extract_header compare_extract ext_make_extract empty_gci
      }

   let term_memo =
      { attribute = WeakMemo.create_default "Proof_term_boot.term_memo.attribute" (**)
           weaken_attribute_header compare_attribute term_make_attribute empty_gci;
        attributes = WeakMemo.create_default "Proof_term_boot.term_memo.attributes" (**)
           weaken_attributes_header compare_attributes term_make_attributes empty_gci;
        arglist = WeakMemo.create_default "Proof_term_boot.term_memo.arglist" (**)
           weaken_arglist_header compare_arglist term_make_arglist empty_gci;
        tactic_parent = WeakMemo.create_default "Proof_term_boot.term_memo.tactic_parent" (**)
           weaken_tactic_parent_header compare_tactic_parent term_make_tactic_parent empty_gci;
        tactic_arg = WeakMemo.create_default "Proof_term_boot.term_memo.tactic_arg" (**)
           weaken_tactic_arg_header compare_tactic_arg term_make_tactic_arg empty_gci;
        extract = WeakMemo.create_default "Proof_term_boot.term_memo.extract" (**)
           weaken_extract_header compare_extract term_make_extract empty_gci
      }
