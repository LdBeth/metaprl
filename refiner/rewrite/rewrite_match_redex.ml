...
struct
             ...
             | RWSeqHyp (name, term') ->
                  ...
                  if i = len then
                     ...
                     Hypothesis (var, term) ->
                        ...
                        let new_bvars = StringSet.add all_bvars var in
                        (*
   ...
   let match_redex addrs stack t tl = function
    ...
    | prog::progs ->
         ...
         ENDIF;
         match_redex_term addrs stack StringSet.empty prog t;
         iter2_3 match_redex_term addrs stack StringSet.empty progs tl
end
