 ...
 * California Inftitute of Technology
 *
...
: sig
   ...
   val compile_so_contractum : strict -> rstack array -> term -> rwterm
   val compile_so_contracta : strict -> rstack array -> term list -> rwterm list
end
