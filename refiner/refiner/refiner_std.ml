...
struct
   ...
   module AddressType = Term_addr_gen.MakeAddressType (TermType)
   ...
   module TermAddr = Term_addr_gen.TermAddr (TermType) (Term) (TermOp) (RefineError)
   module TermMan = Term_man_gen.TermMan (TermType) (Term) (TermOp) (TermAddr) (TermSubst) (RefineError)
