...
*)
   ...
   let split_term' { term_op = (op1, op2); term_terms = btl; comment = com } =
      let btl1, btl2 = split btl in
         { term_op = op1; term_terms = btl1; comment = com },
         { term_op = op2; term_terms = btl2; comment = com }
...
*)
   ...
   let merge_term' x { term_op = op1; term_terms = btl1; comment = com1 }
                     { term_op = op2; term_terms = btl2; comment = com2 } =
      { term_op = merge_op x op1 op2; term_terms = merge_bterms x btl1 btl2; comment = merge_comment x com1 com2 }
...
*)
   ...
   module SeqHyp = struct
      ...
      let fold_map f x t =
         let a, l = (List.fold_left_map f x (to_list t)) in
            a, of_list l
      let lazy_apply = map
   ...
   module Term = struct
      ...
      let mk_term ?(com=[]) (p0 : operator) (p1 : bound_term list) =
         let p0_1, p0_2 = p0 in
         let p1_1, p1_2 = split p1 in
         merge merge_term "Term.mk_term" (wrap2 (Term1.mk_term ~com:com) p0_1 p1_1)
                                         (wrap2 (Term2.mk_term ~com:com) p0_2 p1_2)

      let dest_comment (p0 : term) =
         let p0_1, p0_2 = p0 in
         merge merge_comment "Term.dest_comment" (wrap1 Term1.dest_comment p0_1) (wrap1 Term2.dest_comment p0_2)
   ...
   module TermOp = struct
      ...
      let mk_dep0_term ?(com=[]) (p0 : opname) (p1 : term) =
         let p1_1, p1_2 = p1 in
         merge merge_term "TermOp.mk_dep0_term"
              (wrap2 (TermOp1.mk_dep0_term ~com:com) p0 p1_1)
              (wrap2 (TermOp2.mk_dep0_term ~com:com) p0 p1_2)
      ...
      let mk_string_dep0_dep0_term ?(com=[]) (p0 : opname) (p1 : string) (p2 : term) (p3 : term) =
         let p2_1, p2_2 = p2 in
         let p3_1, p3_2 = p3 in
         merge merge_term "TermOp.mk_string_dep0_dep0_term"
            (wrap4 (TermOp1.mk_string_dep0_dep0_term ~com:com) p0 p1 p2_1 p3_1)
            (wrap4 (TermOp2.mk_string_dep0_dep0_term ~com:com) p0 p1 p2_2 p3_2)
   ...
   module TermAddr = struct
      ...
      let apply_var_fun_arg_at_addr (p0 : (SymbolSet.t -> term -> term * 'a)) (p1 : address) (p2 : SymbolSet.t) (p3 : term) =
         ...
         (* XXX: disabled (merge_poly "TermAddr.apply_var_fun_arg_at_addr - 1" res1_1 res1_2) *) res1_1
