...
#
# Which method do you want to use for display?  The choices are
# Format and Lm_format.  You should use Lm_format unless you
# are experiencing trouble with output from MetaPRL.
#
FORMAT=$FORMAT
...
# (see man gprof).
#
# When enabled, overrides NATIVE_ENABLED and BYTECODE_ENABLED.
